KeysDictionary('enu', (3, 8),
               ...
               Key("temps1",
                   Float(name='val1_0', invalid="NaN", units="C", help='MOTOR_RDA', FITS=('W_ETMP1', 'MOTOR_RDA')),
                   Float(name='val1_1', invalid="NaN", units="C", help='MOTOR_SHUTTER_B', FITS=('W_ETMP2', 'MOTOR_SHUTTER_B')),
                   Float(name='val1_2', invalid="NaN", units="C", help='MOTOR_SHUTTER_R', FITS=('W_ETMP3', 'MOTOR_SHUTTER_R')),
                   Float(name='val1_3', invalid="NaN", units="C", help='BIA_BOX_UPPER', FITS=('W_ETMP4', 'BIA_BOX_UPPER')),
                   Float(name='val1_4', invalid="NaN", units="C", help='BIA_BOX_LOWER', FITS=('W_ETMP5', 'BIA_BOX_LOWER')),
                   Float(name='val1_5', invalid="NaN", units="C", help='FIBER_UNIT_BENCH_LEVEL', FITS=('W_ETMP6', 'FIBER_UNIT_BENCH_LEVEL')),
                   Float(name='val1_6', invalid="NaN", units="C", help='FIBER_UNIT_HEXAPOD_TOP', FITS=('W_ETMP7', 'FIBER_UNIT_HEXAPOD_TOP')),
                   Float(name='val1_7', invalid="NaN", units="C", help='FIBER_UNIT_FIBER_FRAME_TOP', FITS=('W_ETMP8', 'FIBER_UNIT_FIBER_FRAME_TOP')),
                   Float(name='val1_8', invalid="NaN", units="C", help='COLLIMATOR_FRAME_BENCH_LEVEL', FITS=('W_ETMP9', 'COLLIMATOR_FRAME_BENCH_LEVEL')),
                   Float(name='val1_9', invalid="NaN", units="C", help='COLLIMATOR_FRAME_TOP', FITS=('W_ETMP10', 'COLLIMATOR_FRAME_TOP')),
                   help="Bench Temperatures stage1"),
               Key("temps2",
                   Float(name='val1_0', invalid="NaN", units="C", help='BENCH_LEFT_TOP', FITS=('W_ETMP11', 'BENCH_LEFT_TOP')),
                   Float(name='val1_1', invalid="NaN", units="C", help='BENCH_LEFT_BOTTOM', FITS=('W_ETMP12', 'BENCH_LEFT_BOTTOM')),
                   Float(name='val1_2', invalid="NaN", units="C", help='BENCH_RIGHT_TOP', FITS=('W_ETMP13', 'BENCH_RIGHT_TOP')),
                   Float(name='val1_3', invalid="NaN", units="C", help='BENCH_RIGHT_BOTTOM', FITS=('W_ETMP14', 'BENCH_RIGHT_BOTTOM')),
                   Float(name='val1_4', invalid="NaN", units="C", help='BENCH_FAR_TOP', FITS=('W_ETMP15', 'BENCH_FAR_TOP')),
                   Float(name='val1_5', invalid="NaN", units="C", help='BENCH_FAR_BOTTOM', FITS=('W_ETMP16', 'BENCH_FAR_BOTTOM')),
                   Float(name='val1_6', invalid="NaN", units="C", help='BENCH_NEAR_TOP', FITS=('W_ETMP17', 'BENCH_NEAR_TOP')),
                   Float(name='val1_7', invalid="NaN", units="C", help='BENCH_NEAR_BOTTOM', FITS=('W_ETMP18', 'BENCH_NEAR_BOTTOM')),
                   Float(name='val1_8', invalid="NaN", units="C", help='BENCH_CENTRAL_BOTTOM', FITS=('W_ETMP19', 'BENCH_CENTRAL_BOTTOM')),
                   Float(name='val1_9', invalid="NaN", units="C", help='ENU_TEMP_20', FITS=('W_ETMP20', 'ENU_TEMP_20')),

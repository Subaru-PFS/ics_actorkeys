KeysDictionary('enu', (1, 8),
               ...
               Key("shutters",
                   Enum('LOADING', 'LOADED', 'INITIALISING', 'IDLE', 'BUSY', 'FAILED', name='fsm',
                        help='state machine'),
                   Enum('simulation', 'operation', name='mode', help='current mode'),
                   Enum('close', 'open', 'undef', name='position', help='shutters current position'),
               ...
               Key("rexmInfo",
                   UInt(name='switchA', help='switchA state'),
                   UInt(name='switchB', help='switchB state'),
                   Int(name='speed', help='motors speed ustep/sec'),
                   Int(name='position', help='number of ustep '), ),

KeysDictionary('enu', (2, 9),
               ...
               Key("temps1",
                   Float(name='val1_0', invalid="NaN", units="C", help="temp probe #1", FITS=('W_ETMP1', 'ENU_TEMP_1')),
                   Float(name='val1_1', invalid="NaN", units="C", help="temp probe #2", FITS=('W_ETMP2', 'ENU_TEMP_2')),
                   Float(name='val1_2', invalid="NaN", units="C", help="temp probe #3", FITS=('W_ETMP3', 'ENU_TEMP_3')),
                   Float(name='val1_3', invalid="NaN", units="C", help="temp probe #4", FITS=('W_ETMP4', 'ENU_TEMP_4')),
                   Float(name='val1_4', invalid="NaN", units="C", help="temp probe #5", FITS=('W_ETMP5', 'ENU_TEMP_5')),
                   Float(name='val1_5', invalid="NaN", units="C", help="temp probe #6", FITS=('W_ETMP6', 'ENU_TEMP_6')),
                   Float(name='val1_6', invalid="NaN", units="C", help="temp probe #7", FITS=('W_ETMP7', 'ENU_TEMP_7')),
                   Float(name='val1_7', invalid="NaN", units="C", help="temp probe #8", FITS=('W_ETMP8', 'ENU_TEMP_8')),
                   Float(name='val1_8', invalid="NaN", units="C", help="temp probe #9", FITS=('W_ETMP9', 'ENU_TEMP_9')),
                   Float(name='val1_9', invalid="NaN", units="C", help="temp probe #10", FITS=('W_ETMP10', 'ENU_TEMP_10')),
                   help="Bench Temperatures stage1"),
               Key("temps2",
                   Float(name='val1_0', invalid="NaN", units="C", help="temp probe #11", FITS=('W_ETMP11', 'ENU_TEMP_11')),
                   Float(name='val1_1', invalid="NaN", units="C", help="temp probe #12", FITS=('W_ETMP12', 'ENU_TEMP_12')),
                   Float(name='val1_2', invalid="NaN", units="C", help="temp probe #13", FITS=('W_ETMP13', 'ENU_TEMP_13')),
                   Float(name='val1_3', invalid="NaN", units="C", help="temp probe #14", FITS=('W_ETMP14', 'ENU_TEMP_14')),
                   Float(name='val1_4', invalid="NaN", units="C", help="temp probe #15", FITS=('W_ETMP15', 'ENU_TEMP_15')),
                   Float(name='val1_5', invalid="NaN", units="C", help="temp probe #16", FITS=('W_ETMP16', 'ENU_TEMP_16')),
                   Float(name='val1_6', invalid="NaN", units="C", help="temp probe #17", FITS=('W_ETMP17', 'ENU_TEMP_17')),
                   Float(name='val1_7', invalid="NaN", units="C", help="temp probe #18", FITS=('W_ETMP18', 'ENU_TEMP_18')),
                   Float(name='val1_8', invalid="NaN", units="C", help="temp probe #19", FITS=('W_ETMP19', 'ENU_TEMP_19')),
                   Float(name='val1_9', invalid="NaN", units="C", help="temp probe #20", FITS=('W_ETMP20', 'ENU_TEMP_20')),

KeysDictionary('enu', (5, 11),
               ...
               Key('slitFSM',
                   ...
                   Enum('none', 'IDLE', 'LOADING', 'INITIALISING', 'MOVING', 'SLIDING', 'SHUTDOWN', 'FAILED',
                        name='substate', FITS=('W_ENFCAT', 'ENU_FCA_SUBSTATE'), help='slit-hexapod action state-machine'),
                   help='slit state machine'),
               Key('slitMode',
                   Enum('operation', 'simulation', help='fca operation mode',
                        FITS=('W_ENFCAM', 'ENU_FCA_MODE'))),
               Key('slit',
                   Float(name='X', invalid="NaN", units="mm",
                         help='FCA FOCUS position, wrt optical axis (+ towards collimator)',
                         FITS=('W_ENFCAX', 'ENU_FCA_FOCUS')),
                   Float(name='Y', invalid="NaN", units="mm",
                         help='FCA_Y position, wrt wavelength axis (+ towards red wl)',
                         FITS=('W_ENFCAY', 'ENU_FCA_WAVELENGTH')),
                   Float(name='Z', invalid="NaN", units="mm",
                         help='FCA_Z position, wrt fibers axis (+ towards low fiber id)',
               ...
               Key('slitTool',
                ...
                Key('slitActuators',
                   ...
                   Float(name='Y', invalid="NaN", units="mm"),
                   Float(name='Z', invalid="NaN", units="mm"),
                   Float(name='U', invalid="NaN", units="deg"),
                   Float(name='V', invalid="NaN", units="deg"),
                   Float(name='W', invalid="NaN", units="deg"), help='slit raw actuators reading'),
               Key('hxpStatus',
               ...
               Key("slitAtSpeed",
                   Bool('False', 'True', help='Hexapod at speed.')),
               ...
               Key('biashaMeasures',
                   Float(name='transientTimeOpening', units='s', invalid="NaN",
                         help='transient time opening the shutters as measured by the biasha board.'),
                   Float(name='shuttersFullyOpen', units='s', invalid="NaN",
                         FITS=('W_ENSHTI', 'ENU_SHUTTERS_TIME_FULLY_OPEN'),
                         help='time in seconds with shutters fully open during exposure.'),
                   Float(name='transientTimeClosing', units='s', invalid="NaN",
                         help='transient time closing the shutters as measured by the biasha board.')),
               Key('shutterTimings',
                   Int(name='visit', help='pfsVisit'),
                   String(name='integrationStartedAt', help='integrationStartedAt(ISO-formatted)'),
                   String(name='openReturnedAt', help='openReturnedAt(ISO-formatted)'),
                   String(name='integrationEndedAt', help='integrationEndedAt(ISO-formatted)'),
                   String(name='closeReturnedAt', help='closeReturnedAt(ISO-formatted)')),
               ...
               Key("redResolution",
                   Int(name='visit', help='pfsVisit'),
                   String(name='position', help='rda position during integration',
               ...
               Key('hgar',
                   Bool('off', 'on', name='state', help='IIS Hg-Ar lamp state'),
               ...
               Key('argon',
                   Bool('off', 'on', name='state', help='IIS Argon lamp state'),
                   String(name='offTime', help='timestamp when lamp turned off - ISO formatted'),
                   String(name='onTime', help='timestamp when lamp turned on - ISO formatted')),
               Key('neon',
                   Bool('off', 'on', name='state', help='IIS Neon lamp state'),
                   String(name='offTime', help='timestamp when lamp turned off - ISO formatted'),
                   String(name='onTime', help='timestamp when lamp turned on - ISO formatted')),
               Key('krypton',
                   Bool('off', 'on', name='state', help='IIS Krypton lamp state'),
                   String(name='offTime', help='timestamp when lamp turned off - ISO formatted'),
                   String(name='onTime', help='timestamp when lamp turned on - ISO formatted')),
               Key('halogen',
                   Bool('off', 'on', name='state', help='IIS Halogen lamp state'),
                   String(name='offTime', help='timestamp when lamp turned off - ISO formatted'),
                   String(name='onTime', help='timestamp when lamp turned on - ISO formatted')),

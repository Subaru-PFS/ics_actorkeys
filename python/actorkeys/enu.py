KeysDictionary('enu', (3, 8),
               ...
               Key("temps1",
                   Float(name='val1_0', invalid="NaN", units="C", help='MOTOR_RDA', FITS=('W_ETMP1', 'MOTOR_RDA'), STS=0),
                   Float(name='val1_1', invalid="NaN", units="C", help='MOTOR_SHUTTER_B', FITS=('W_ETMP2', 'MOTOR_SHUTTER_B'), STS=1),
                   Float(name='val1_2', invalid="NaN", units="C", help='MOTOR_SHUTTER_R', FITS=('W_ETMP3', 'MOTOR_SHUTTER_R'), STS=2),
                   Float(name='val1_3', invalid="NaN", units="C", help='BIA_BOX_UPPER', FITS=('W_ETMP4', 'BIA_BOX_UPPER'), STS=3),
                   Float(name='val1_4', invalid="NaN", units="C", help='BIA_BOX_LOWER', FITS=('W_ETMP5', 'BIA_BOX_LOWER'), STS=4),
                   Float(name='val1_5', invalid="NaN", units="C", help='FIBER_UNIT_BENCH_LEVEL', FITS=('W_ETMP6', 'FIBER_UNIT_BENCH_LEVEL'), STS=5),
                   Float(name='val1_6', invalid="NaN", units="C", help='FIBER_UNIT_HEXAPOD_TOP', FITS=('W_ETMP7', 'FIBER_UNIT_HEXAPOD_TOP'), STS=6),
                   Float(name='val1_7', invalid="NaN", units="C", help='FIBER_UNIT_FIBER_FRAME_TOP', FITS=('W_ETMP8', 'FIBER_UNIT_FIBER_FRAME_TOP'), STS=7),
                   Float(name='val1_8', invalid="NaN", units="C", help='COLLIMATOR_FRAME_BENCH_LEVEL', FITS=('W_ETMP9', 'COLLIMATOR_FRAME_BENCH_LEVEL'), STS=8),
                   Float(name='val1_9', invalid="NaN", units="C", help='COLLIMATOR_FRAME_TOP', FITS=('W_ETMP10', 'COLLIMATOR_FRAME_TOP'), STS=9),
                   help="Bench Temperatures stage1"),
               Key("temps2",
                   Float(name='val1_0', invalid="NaN", units="C", help='BENCH_LEFT_TOP', FITS=('W_ETMP11', 'BENCH_LEFT_TOP'), STS=10),
                   Float(name='val1_1', invalid="NaN", units="C", help='BENCH_LEFT_BOTTOM', FITS=('W_ETMP12', 'BENCH_LEFT_BOTTOM'), STS=11),
                   Float(name='val1_2', invalid="NaN", units="C", help='BENCH_RIGHT_TOP', FITS=('W_ETMP13', 'BENCH_RIGHT_TOP'), STS=12),
                   Float(name='val1_3', invalid="NaN", units="C", help='BENCH_RIGHT_BOTTOM', FITS=('W_ETMP14', 'BENCH_RIGHT_BOTTOM'), STS=13),
                   Float(name='val1_4', invalid="NaN", units="C", help='BENCH_FAR_TOP', FITS=('W_ETMP15', 'BENCH_FAR_TOP'), STS=14),
                   Float(name='val1_5', invalid="NaN", units="C", help='BENCH_FAR_BOTTOM', FITS=('W_ETMP16', 'BENCH_FAR_BOTTOM'), STS=15),
                   Float(name='val1_6', invalid="NaN", units="C", help='BENCH_NEAR_TOP', FITS=('W_ETMP17', 'BENCH_NEAR_TOP'), STS=16),
                   Float(name='val1_7', invalid="NaN", units="C", help='BENCH_NEAR_BOTTOM', FITS=('W_ETMP18', 'BENCH_NEAR_BOTTOM'), STS=17),
                   Float(name='val1_8', invalid="NaN", units="C", help='BENCH_CENTRAL_BOTTOM', FITS=('W_ETMP19', 'BENCH_CENTRAL_BOTTOM'), STS=18),
                   Float(name='val1_9', invalid="NaN", units="C", help='ENU_TEMP_20', FITS=('W_ETMP20', 'ENU_TEMP_20'), STS=19),

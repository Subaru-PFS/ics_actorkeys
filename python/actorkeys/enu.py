KeysDictionary('enu', (4, 8),
               ...
               Key('slit',
                   Float(name='X', invalid="NaN", units="mm",
                         FITS=('W_ENFCAX', 'ENU_FCA_FOCUS, wrt optical axis (+ towards collimator)')),
                   Float(name='Y', invalid="NaN", units="mm",
                         FITS=('W_ENFCAY', 'ENU_FCA_WAVELENGTH, wrt wavelength axis (+ towards red wl)')),
                   Float(name='Z', invalid="NaN", units="mm",
                         FITS=('W_ENFCAZ', 'ENU_FCA_FIBERS, wrt fibers axis (+ towards low fiber id)')),
               ...
               Key('biashaFSM',
                   ...
                   Enum('none', 'IDLE', 'LOADING', 'INITIALISING', 'FAILED', 'BUSY', 'EXPOSING', 'OPENRED', 'OPENBLUE',
                        'BIA', name='substate',
                        FITS=('W_ENBSHT', 'ENU_BIASHA_SUBSTATE'), STS=0, help='biasha state machine')),
               Key('biashaMode',
               ...
               Key('biaConfig',
                   ...
                   Int(name='duty', help='power duty cycle(0-255)'),
                   Int(name='strobeDuty', help='strobe duty cycle(0-100)')),
               Key('biaStatus',
                   Int(name='power', units='percent', help='bia power(%)'),
                   Int(name='pulseGap', units='ms', help='gap between pulse (0:continuous)'),
                   Int(name='strobeDuty', units='percent', help='gap between pulse (0:continuous)'),

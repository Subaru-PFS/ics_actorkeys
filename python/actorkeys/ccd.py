KeysDictionary('ccd', (2, 4),
               ...
               Key("overscanLevels",
                   Float(invalid="NaN", units="ADU", name='amp0_0', help='CCD0 amp0 serial overscan median level'),
                   Float(invalid="NaN", units="ADU", name='amp0_1', help='CCD0 amp1 serial overscan median level'),
                   Float(invalid="NaN", units="ADU", name='amp0_2', help='CCD0 amp2 serial overscan median level'),
                   Float(invalid="NaN", units="ADU", name='amp0_3', help='CCD0 amp3 serial overscan median level'),
                   Float(invalid="NaN", units="ADU", name='amp1_0', help='CCD1 amp0 serial overscan median level'),
                   Float(invalid="NaN", units="ADU", name='amp1_1', help='CCD1 amp1 serial overscan median level'),
                   Float(invalid="NaN", units="ADU", name='amp1_2', help='CCD1 amp2 serial overscan median level'),
                   Float(invalid="NaN", units="ADU", name='amp1_3', help='CCD1 amp3 serial overscan median level')),
               Key("overscanNoise",
                   Float(invalid="NaN", units="ADU", name='amp0_0', help='CCD0 amp0 serial overscan noise level'),
                   Float(invalid="NaN", units="ADU", name='amp0_1', help='CCD0 amp1 serial overscan noise level'),
                   Float(invalid="NaN", units="ADU", name='amp0_2', help='CCD0 amp2 serial overscan noise level'),
                   Float(invalid="NaN", units="ADU", name='amp0_3', help='CCD0 amp3 serial overscan noise level'),
                   Float(invalid="NaN", units="ADU", name='amp1_0', help='CCD1 amp0 serial overscan noise level'),
                   Float(invalid="NaN", units="ADU", name='amp1_1', help='CCD1 amp1 serial overscan noise level'),
                   Float(invalid="NaN", units="ADU", name='amp1_2', help='CCD1 amp2 serial overscan noise level'),
                   Float(invalid="NaN", units="ADU", name='amp1_3', help='CCD1 amp3 serial overscan noise level')),
               Key("visitQA",
                   Int(name="visit", help="the PFS visit"),
                   String(name="status", help="QA status string"))
               )

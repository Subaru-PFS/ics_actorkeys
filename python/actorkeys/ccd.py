KeysDictionary('ccd', (2,2),
               ...
               Key("readoutVoltages0",
                   ...
                   Float(invalid="NaN", units="V", name='OG', help='ccd0 OG voltage, measured',
                         FITS=('W_FR0OG', 'FEE_CCD0_READ_OG')), 
                   Float(invalid="NaN", units="V", name='RD', help='ccd0 RD voltage, measured',
                         FITS=('W_FR0RD', 'FEE_CCD0_READ_RD')), 
                   Float(invalid="NaN", units="V", name='OD', help='ccd0 OD voltage, measured',
                         FITS=('W_FR0OD', 'FEE_CCD0_READ_OD')), 
                   Float(invalid="NaN", units="V", name='BB', help='ccd0 BB voltage, measured',
               ...
               Key("readoutVoltages1",
                   ...
                   Float(invalid="NaN", units="V", name='OG', help='ccd1 OG voltage, measured',
                         FITS=('W_FR1OG', 'FEE_CCD1_READ_OG')), 
                   Float(invalid="NaN", units="V", name='RD', help='ccd1 RD voltage, measured',
                         FITS=('W_FR1RD', 'FEE_CCD1_READ_RD')), 
                   Float(invalid="NaN", units="V", name='OD', help='ccd1 OD voltage, measured',
                         FITS=('W_FR1OD', 'FEE_CCD1_READ_OD')), 
                   Float(invalid="NaN", units="V", name='BB', help='ccd1 BB voltage, measured',

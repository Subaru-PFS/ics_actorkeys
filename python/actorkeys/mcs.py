KeysDictionary('mcs', (1, 10),
               ...
               Key('exposureState',
                   Enum('IDLE','FLUSHING','INTEGRATING','READING','ABORTED','DONE', 'EXPOSING', name="state"),
                   help='The current state of the exposure'),
               Key('biaControl',
                   Enum('off', 'on', name="state"),
                   help='whether mcs drives the sps bia during its exposures'),

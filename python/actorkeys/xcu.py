KeysDictionary("xcu", (10, 2),
               ...
               Key("coolerStatus",
                   ...
                   String(name="errors",
                          STS=2, help="human-oriented error string"),
               ...
               Key("cooler2Status",
                   ...
                   UInt(name="errorMask", reprFmt="0x%02x"),
                   String(name="errors",
                          STS=3, help="human-oriented error string"),
                   Float(invalid="NaN", units="W", name='minPower'),
                   Float(invalid="NaN", units="W", name='maxPower'),
                   Float(invalid="NaN", units="W", name='power')),
               ...
               Key("ionpump1",
                   ...
                   Float(name='Pressure', invalid="NaN", units="Torr",
                         ...
                         STS=14, help='ionpump 1 pressure'),
               ...
               Key("ionpump2",
                   ...
                   Float(name='Pressure', invalid="NaN", units="Torr",
                         ...
                         STS=16, help='ionpump 2 pressure'),
               ...
               Key("ionpump1Errors",
                   ...
                   String(name="errors",
                          STS=17, help="human-oriented error string")),
               Key("ionpump2Errors",
                   UInt(name="errorMask", reprFmt="0x%05x"),
                   Enum("OK", "ERROR", name="errorState"),
                   String(name="errors",
                          STS=18, help="human-oriented error string")),

KeysDictionary("xcu", (5, 1),
               ...
               Key("heaters",
                   Int(name='H1enabled', help='is ccd enabled'),
                   Int(name='HP1enabled', help='is spreader enabled'),
                   Float(name='H1fraction', help='fractional power to ccd heater. 0..1'),
                   Float(name='HP1fraction', help='fractional power to spreader heater. 0 or 1'),
                   Int(name='H2enabled', help='is asic enabled'),
                   Int(name='HP2enabled', help='is heater 4 enabled'),
                   Float(name='H2fraction', help='fractional power to asic heater, 0..1'),
                   Float(name='HP2fraction', help='fractional power to heater 4, 0 or 1'),

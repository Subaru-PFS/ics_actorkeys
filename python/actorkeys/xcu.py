...
KeysDictionary("xcu", (11, 8),
               ...
               Key("cooler2Status",
                   ...
                   UInt(name="errorMask", reprFmt="0x%02x"),
                   String(name="errors",
                          STS=17, help="Cooler2 error string"),
                   Float(invalid="NaN", units="W", name='minPower'),
                   Float(invalid="NaN", units="W", name='maxPower'),
                   Float(invalid="NaN", units="W", name='power')),
               ...
               Key("coolerTemps",
                   ...
                   Float(invalid="NaN", units="K", name='tip',
                         ...
                         STS=20, help="Cooler1 tip temperature"),
                   Float(invalid="NaN", units="W", name='power',
                         FITS=('W_XCL1PW', 'XCU_COOLER1_POWER'),
                         STS=2, help="Cooler1 power"),
               ...
               Key("cooler2Temps",
                   ...
                   Float(invalid="NaN", units="degC", name='reject',
                         ...
                         STS=18, help="Cooler2 reject temperature"),
                   Float(invalid="NaN", units="K", name='tip',
                         FITS=('W_XCL2TP', 'XCU_COOLER2_TIP_TEMP'),
                         STS=21, help="Cooler2 tip temperature"),
                   Float(invalid="NaN", units="W", name='power',
                         FITS=('W_XCL2PW', 'XCU_COOLER2_POWER'),
                         STS=19, help="Cooler2 power"),
               ...
               Key("nirTemps",
                   Float(name='mangin', invalid="NaN", units="K", help="Mangin mirror temp",FITS=("W_XTMANG", "XCU_TEMP_MANGIN")),
                   Float(name='mirrorCell1', invalid="NaN", units="K", help="Mirror cell temp #1",FITS=("W_XTMCL1", "XCU_TEMP_MIRRORCELL_1")),
                   Float(name='mirrorCell2', invalid="NaN", units="K", help="Mirror cell temp #2",FITS=("W_XTMCL2", "XCU_TEMP_MIRRORCELL_2")),
                   Float(name='sicSpreader', invalid="NaN", units="K", help="SiC spreader temp",  FITS=("W_XTSICS", "XCU_TEMP_SIC_SPREADER")),
                   Float(name='frontRing', invalid="NaN", units="K", help="Front Barrel ring temp", FITS=("W_XTFBAR", "XCU_TEMP_FRONT_BARREL")),
                   Float(name='spreaderPan', invalid="NaN", units="K", help="Spreader pan temp", FITS=("W_XTSPAN", "XCU_TEMP_SPREADER")),
                   Float(name='radShield1', invalid="NaN", units="K", help="Radiation shield temp #1", FITS=("W_XTSHD1", "XCU_TEMP_RADSHIELD_1")),
                   Float(name='radShield2', invalid="NaN", units="K", help="Radiation shield temp #2", FITS=("W_XTSHD2", "XCU_TEMP_RADSHIELD_2")),
                   Float(name='ASIC', invalid="NaN", units="K", help="ASIC temp", STS=16, FITS=("W_XTASIC", "XCU_TEMP_ASIC")),
                   Float(name='detector1', invalid="NaN", units="K", help="Detector temp #1", STS=12, FITS=("W_XTDET1", "XCU_TEMP_DETECTOR_1")),
                   Float(name='detector2', invalid="NaN", units="K", help="Detector temp #2", STS=13, FITS=("W_XTDET2", "XCU_TEMP_DETECTOR_2")),
                   help="NIR cryostat temperatures from the IDG board"),
               ...
               Key("heaters",
                   ...
                   Float(name='HP1fraction',
                         ...
                         help='Shield heater power: 0 or 1'),
                   Int(name='H2enabled',

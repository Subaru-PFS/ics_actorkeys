KeysDictionary("xcu", (10, 2),
               ...
               Key("visTemps",
                   Float(name='mangin', invalid="NaN", units="K", help="Mangin mirror"),
                   Float(name='spiderRod', invalid="NaN", units="K", help="Spider rod"),
                   Float(name='detectorBox', invalid="NaN", units="K", help="Detector Box"),
                   Float(name='spreader', invalid="NaN", units="K", help="Thermal spreader"),
                   Float(name='frontRing', invalid="NaN", units="K", help="Front Barrel ring"),
                   Float(name='detector1', invalid="NaN", units="K", help="Detector probe #1"),
                   Float(name='detector2', invalid="NaN", units="K", help="Detector probe #2"),

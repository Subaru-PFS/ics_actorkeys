KeysDictionary("xcu", (2, 6),
               ...
               Key('turboTemps',
                ...
                Key("ccdMotor1",
                    ...
                    Int(invalid=-1, name='home switch'),
                    Int(invalid=-1, name='far limit switch'),
                    ...
                    help="Motor 1: 12:00 in visible dewar"),
                Key("ccdMotor2",
                    Enum('OK', 'Unknown', name='status'),
                    Int(invalid=-1, name='home switch'),
                    Int(invalid=-1, name='far limit switch'),
                    ...
                    Float(invalid="NaN", units="um", name='position',
                          help='arm vertex offset from home position'), 
                    help="Motor 2: 4:00 in visible dewar"),
                Key("ccdMotor3",
                    Enum('OK', 'Unknown', name='status'),
                    Int(invalid=-1, name='home switch'),
                    Int(invalid=-1, name='far limit switch'),
                    ...
                    Float(invalid="NaN", units="um", name='position',
                          help='arm vertex offset from home position'), 
                    help="Motor 3: 8:00 in visible dewar"),
)

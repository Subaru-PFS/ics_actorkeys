KeysDictionary("xcu", (10, 2),
               ...
               Key("coolerStatus",
                   Enum("ON","OFF","POWER",
                        name="state",
                        help="Control Loop State",
                        STS=0),
                   UInt(name="errorMask", reprFmt="0x%02x"),
                   String(name="errors", help="human-oriented error string", STS=1),
               ...
               Key("cooler2Status",
                   Enum("ON","OFF","POWER",
                        name="state",
                        help="the state of the control loop", STS=2),
                   UInt(name="errorMask", reprFmt="0x%02x"),
                   String(name="errors", help="human-oriented error string", STS=3),
                   Float(invalid="NaN", units="W", name='minPower'),
                   Float(invalid="NaN", units="W", name='maxPower'),
                   Float(invalid="NaN", units="W", name='power')),
               ...
               Key("ionpump1",
                   Bool('0', '1', name='enabled', help='ionpump1 enabled',
                        FITS=('W_XIP1EN', 'XCU_IONPUMP1_ENABLED'), STS=13),
                   ...
                   Float(name='Pressure', invalid="NaN", units="Torr",
                         ...
                         FITS=('W_XIP1PR', 'XCU_IONPUMP1_PRESSURE'), STS=14),
                   help="Ion pump status. Pump #1 for this dewar"),
               Key("ionpump2",
                   Bool('0', '1', name='enabled', help='ionpump2 enabled',
                        FITS=('W_XIP2EN', 'XCU_IONPUMP2_ENABLED'), STS=15),
                   Float(name='Voltage', invalid="NaN", units="V"),
                   Float(name='Current', invalid="NaN", units="A"),
                   Float(name='Temperature', invalid="NaN", units="K"),
                   Float(name='Pressure', invalid="NaN", units="Torr",
                         help='ionpump 2 pressure',
                         FITS=('W_XIP2PR', 'XCU_IONPUMP2_PRESSURE'), STS=16),
                   help="Ion pump status. Pump #2 for this dewar"),

               Key("ionpump1Errors",
                   UInt(name="errorMask", reprFmt="0x%05x"),
                   Enum("OK", "ERROR", name="errorState"),
                   String(name="errors", help="human-oriented error string"), STS=17),
               Key("ionpump2Errors",
                   UInt(name="errorMask", reprFmt="0x%05x"),
                   Enum("OK", "ERROR", name="errorState"),
                   String(name="errors", help="human-oriented error string"), STS=18),
               ...
               Key("pcmPower1",
                   ...
                   Float(name="volts", units='V',
                         ...
                         FITS=('W_XSUP1V', 'XCU_PCM_POWER_SUPPLY1'), STS=19),
                   Float(name="amps"),
                   Float(name="watts")),
               Key("pcmPower2",
                   String(name="name"),
                   ...
                   Float(name="volts", units='V',
                         ...
                         FITS=('W_XSUP2V', 'XCU_PCM_POWER_SUPPLY2'), STS=20),
                   Float(name="amps"),
                   Float(name="watts")),
               Key("pcmPort1",
                   String(name="name"),
               ...
               Key("heaters",
                   Int(name='H1enabled', help='asic heater enabled',
                       FITS=('W_XH1ENA', 'XCU_ASIC_HEATER_ENABLED'), STS=33),
                   Int(name='HP1enabled', help='shield heater enabled',
                       FITS=('W_XHP1EN', 'XCU_SHIELD_HEATER_ENABLED'), STS=34),
                   Float(name='H1fraction', help='frac power to asic heater: 0..1',
                         FITS=('W_XH1FRA', 'XCU_ASIC_HEATER_FRACTION'), STS=35),
                   Float(name='HP1fraction', help='frac power to shield heater: 0 or 1',
                         FITS=('W_XHP2FR', 'XCU_SHIELD_HEATER_FRACTION'), STS=36),
                   Int(name='H2enabled', help='ccd heater enabled',
                       FITS=('W_XH2ENA', 'XCU_CCD_HEATER_ENABLED'), STS=37),
                   Int(name='HP2enabled', help='spreader heater enabled',
                       FITS=('W_XHP2EN', 'XCU_SPREADER_HEATER_ENABLED'), STS=38),
                   Float(name='H2fraction', help='frac power to ccd heater: 0..1',
                         FITS=('W_XH2FRA', 'XCU_CCD_HEATER_FRACTION'), STS=39),
                   Float(name='HP2fraction', help='frac power to spreader: 0 or 1',
                         FITS=('W_XHP2FR', 'XCU_SPREADER_HEATER_FRACTION'), STS=40),
                   help='status of the heaters.'),

               Key("gatevalve",
                   UInt(),
                   Enum('Open', 'Closed', 'Unknown', 'Invalid',
                        name='position', help='actual gatevalve position',
                        FITS=('W_XGATPS', 'XCU_GATEVALVE_POSITION'), STS=41),
                   Enum('Open', 'Closed', 'Blocked', 'Invalid', 'TimedOut',
                        name='controlState', help='gatevalve request status',
                        FITS=('W_XGATRQ', 'XCU_GATEVALVE_REQUESTED_POS'), STS=42),
               ...
               Key("turboSpeed",
                   Int(units="rpm", help='turbo pump speed',
                       FITS=('W_XTBOSP', 'XCU_TURBO_SPEED'), STS=43)),
               Key("turboStatus",

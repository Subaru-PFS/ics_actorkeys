KeysDictionary("xcu", (10, 3),
               ...
               Key("visTemps",
                   ...
                   Float(name='detectorBox', invalid="NaN", units="K", help="Detector Box temp", FITS=("W_XTMDBX1", "XCU_TEMP_DETBOX_1")),
                   Float(name='spreader', invalid="NaN", units="K", help="Thermal spreader temp", FITS=("W_XTCBX2", "XCU_TEMP_DETBOX_2")),

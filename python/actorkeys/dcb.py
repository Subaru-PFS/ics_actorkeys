KeysDictionary('dcb', (3, 5),
               ...
               Key("dcbMasks",
                   String(name="coll01", FITS=('W_DMSK01', 'DCB_MASK_COLL_01')),
                   String(name="coll02", FITS=('W_DMSK02', 'DCB_MASK_COLL_02')),
                   String(name="coll03", FITS=('W_DMSK03', 'DCB_MASK_COLL_03')),
                   String(name="coll04", FITS=('W_DMSK04', 'DCB_MASK_COLL_04')),
                   String(name="coll05", FITS=('W_DMSK05', 'DCB_MASK_COLL_05')),
                   String(name="coll06", FITS=('W_DMSK06', 'DCB_MASK_COLL_06')),
                   String(name="coll07", FITS=('W_DMSK07', 'DCB_MASK_COLL_07')),
                   String(name="coll08", FITS=('W_DMSK08', 'DCB_MASK_COLL_08')),
                   String(name="coll09", FITS=('W_DMSK09', 'DCB_MASK_COLL_09')),
                   String(name="coll10", FITS=('W_DMSK10', 'DCB_MASK_COLL_10')),
                   String(name="coll11", FITS=('W_DMSK11', 'DCB_MASK_COLL_11')),
                   String(name="coll12", FITS=('W_DMSK12', 'DCB_MASK_COLL_12')),
                   ),
               Key("dcbBundles",
                   String(name="coll01", FITS=('W_DBNL01', 'DCB_BUNDLE_COLL_01')),
                   String(name="coll02", FITS=('W_DBNL02', 'DCB_BUNDLE_COLL_02')),
                   String(name="coll03", FITS=('W_DBNL03', 'DCB_BUNDLE_COLL_03')),
                   String(name="coll04", FITS=('W_DBNL04', 'DCB_BUNDLE_COLL_04')),
                   String(name="coll05", FITS=('W_DBNL05', 'DCB_BUNDLE_COLL_05')),
                   String(name="coll06", FITS=('W_DBNL06', 'DCB_BUNDLE_COLL_06')),
                   String(name="coll07", FITS=('W_DBNL07', 'DCB_BUNDLE_COLL_07')),
                   String(name="coll08", FITS=('W_DBNL08', 'DCB_BUNDLE_COLL_08')),
                   String(name="coll09", FITS=('W_DBNL09', 'DCB_BUNDLE_COLL_09')),
                   String(name="coll10", FITS=('W_DBNL10', 'DCB_BUNDLE_COLL_10')),
                   String(name="coll11", FITS=('W_DBNL11', 'DCB_BUNDLE_COLL_11')),
                   String(name="coll12", FITS=('W_DBNL12', 'DCB_BUNDLE_COLL_12')),
                   ),
               Key("dcbConfigDate",
               ...
               Key('filterwheelMode',
                   Enum('operation', 'simulation', help='sources operation mode')),
               Key('linewheel',
                   Int(name='position', help='line wheel position (1-5)', FITS=('W_AITLWH', 'AIT_DCB_LINEWHEEL'))),
               Key('qthwheel',
                   Int(name='position', help='qth wheel position (1-5)', FITS=('W_AITQWH', 'AIT_DCB_QTHWHEEL'))),
               Key('adc',

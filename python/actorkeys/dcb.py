KeysDictionary('dcb', (3, 13),
               ...
               Key("dcbMasks",
                   String(name="mask1", FITS=('W_DMSK01', 'DCB_MASK01'), help='DCB collimator 01 mask aperture'),
                   String(name="mask2", FITS=('W_DMSK02', 'DCB_MASK02'), help='DCB collimator 02 mask aperture'),
                   String(name="mask3", FITS=('W_DMSK03', 'DCB_MASK03'), help='DCB collimator 03 mask aperture'),
                   String(name="mask4", FITS=('W_DMSK04', 'DCB_MASK04'), help='DCB collimator 04 mask aperture'),
                   String(name="mask5", FITS=('W_DMSK05', 'DCB_MASK05'), help='DCB collimator 05 mask aperture'),
                   String(name="mask6", FITS=('W_DMSK06', 'DCB_MASK06'), help='DCB collimator 06 mask aperture'),
                   String(name="mask7", FITS=('W_DMSK07', 'DCB_MASK07'), help='DCB collimator 07 mask aperture'),
                   String(name="mask8", FITS=('W_DMSK08', 'DCB_MASK08'), help='DCB collimator 08 mask aperture'),
                   String(name="mask9", FITS=('W_DMSK09', 'DCB_MASK09'), help='DCB collimator 09 mask aperture'),
                   String(name="mask10", FITS=('W_DMSK10', 'DCB_MASK10'), help='DCB collimator 10 mask aperture'),
                   String(name="mask11", FITS=('W_DMSK11', 'DCB_MASK11'), help='DCB collimator 11 mask aperture'),
                   String(name="mask12", FITS=('W_DMSK12', 'DCB_MASK12'), help='DCB collimator 12 mask aperture')),
               Key("dcbBundles",
                   String(name="bundle1", FITS=('W_DBNL01', 'DCB_BUNDLE01'), help='DCB collimator 01 fiber bundle config'),
                   String(name="bundle2", FITS=('W_DBNL02', 'DCB_BUNDLE02'), help='DCB collimator 02 fiber bundle config'),
                   String(name="bundle3", FITS=('W_DBNL03', 'DCB_BUNDLE03'), help='DCB collimator 03 fiber bundle config'),
                   String(name="bundle4", FITS=('W_DBNL04', 'DCB_BUNDLE04'), help='DCB collimator 04 fiber bundle config'),
                   String(name="bundle5", FITS=('W_DBNL05', 'DCB_BUNDLE05'), help='DCB collimator 05 fiber bundle config'),
                   String(name="bundle6", FITS=('W_DBNL06', 'DCB_BUNDLE06'), help='DCB collimator 06 fiber bundle config'),
                   String(name="bundle7", FITS=('W_DBNL07', 'DCB_BUNDLE07'), help='DCB collimator 07 fiber bundle config'),
                   String(name="bundle8", FITS=('W_DBNL08', 'DCB_BUNDLE08'), help='DCB collimator 08 fiber bundle config'),
                   String(name="bundle9", FITS=('W_DBNL09', 'DCB_BUNDLE09'), help='DCB collimator 09 fiber bundle config'),
                   String(name="bundle10", FITS=('W_DBNL10', 'DCB_BUNDLE10'), help='DCB collimator 10 fiber bundle config'),
                   String(name="bundle11", FITS=('W_DBNL11', 'DCB_BUNDLE11'), help='DCB collimator 11 fiber bundle config'),
                   String(name="bundle12", FITS=('W_DBNL12', 'DCB_BUNDLE12'), help='DCB collimator 12 fiber bundle config')),
               ...
               Key('xenon',
                   ...
                   String(name='onTime', help='timestamp when lamp turned on - ISO formatted')),
               Key('allFiberLamp',
                   Bool('off', 'on', name='state', help='allFiberLamp state'),
                   String(name='offTime', help='timestamp when lamp turned off - ISO formatted'),
                   String(name='onTime', help='timestamp when lamp turned on - ISO formatted')),

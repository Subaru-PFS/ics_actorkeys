KeysDictionary('dcb', (3, 0),
               ...
               Key('metaFSM',
                   ...
                   Enum('none', 'IDLE', 'LOADING', 'INITIALISING', 'BUSY', 'MOVING', 'WARMING', 'TURNING_OFF', 'SWITCHING',
               ...
               Key('deuterium',
                   ...
                   Int(name='elapsedTime', help='number of secondssince lamp is on')),
               Key('argon',

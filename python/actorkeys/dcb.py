KeysDictionary('dcb', (3, 2),
               ...
               Key('filterwheelMode',
                   Enum('operation', 'simulation', help='sources operation mode')),
               Key('linewheel',
                   Int(name='position', help='line wheel position (1-5)', FITS=('W_DCBLWH', 'AIT_DCB_LINEWHEEL'))),
               Key('qthwheel',
                   Int(name='position', help='qth wheel position (1-5)', FITS=('W_DCBQWH', 'AIT_DCB_QTHWHEEL'))),
               Key('adc',

KeysDictionary('peb', (1, 5),
               ...
               Key('leakage',
                      Int(name='Leakage', units='bool', STS=5, help='No Leakage indicator'),
                      Int(name='Disconnect', units='bool', STS=6, help='Leakage sensor connected'),
                   help='PFI Ebox leakage sensor'),
               Key('valve_status', 
                      Int(name='Valve_status', units='bool', STS=28, help='Status of valve safe locker')),
               Key('ledperiod',
